...
abstract class BaseMatchsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'team_a_logo'                 => new sfWidgetFormFilterInput(),
      ...
      'team_b_logo'                 => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'team_a_logo'                 => new sfValidatorPass(array('required' => false)),
      ...
      'team_b_logo'                 => new sfValidatorPass(array('required' => false)),
